<div>
                            ...
                            <thead>
                                <tr class="text-theme-1">
                                    ...
                                    <th class="border-b-2 dark:border-dark-5 whitespace-nowrap" width="30%">
                                        DESCRIPCION</th>
                                    <th class="border-b-2 dark:border-dark-5 whitespace-nowrap text-center">CATEGORIA
                                    </th>
                            ...
                            <tbody>
                                ...
                                @forelse($products as $product)
                                    ...
                                    <tr class="dark:bg-dark-1 {{ $loop->index % 2 > 0 ? 'bg-gray-200' : '' }}">
                                        <td>
                                            <img src="{{ $product->img }}" data-action="zoom" alt=""
                                                width="100">
                                        </td>
    ...
    <script>
        ...
        // se usa para ver si es un evento para agregar registro o para actualizar
